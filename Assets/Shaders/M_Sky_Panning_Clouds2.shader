Shader "Unreal/M_Sky_Panning_Clouds2"
{
    ...
    SubShader
    {
        ...
        //BLEND_ADDITIVE Tags  { "RenderPipeline"="UniversalPipeline" "RenderType"="Transparent" "UniversalMaterialType" = "Unlit" "Queue"="Transparent" }
        Pass
        {
        ...
        #include "M_Sky_Panning_Clouds2.hlsl"
